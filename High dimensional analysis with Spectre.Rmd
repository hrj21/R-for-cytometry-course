...
We'll start by installing and loading the Spectre package by installing it directly from GitHub. We also install the *EnhancedVolcano* package from Bioconductor.
